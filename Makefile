...
all:	lander spring spring_euler spring_verlet
...
spring_euler: spring_euler.o

spring_verlet: spring_verlet.o

.cpp.o:
	$(CC) ${CCSW} -c $<

clean:
	echo cleaning up; /bin/rm -f core *.o lander spring spring_euler spring_verlet